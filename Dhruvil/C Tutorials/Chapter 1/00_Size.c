...
int main()
{
    ...
    // The Size of enum in C language is 2 Bytes.
    printf("the size of given char abcd is %d \n", sizeof(abcd));
    printf("the size of given no 522445 is %d \n", sizeof(522445));
    printf("the size of given no 522445.00 is %d \n", sizeof(522445.00));
    printf("the size of double is %d \n", sizeof(f));
    return 0;
}
